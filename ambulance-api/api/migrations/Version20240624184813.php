 ...
 */
final class Version20240624184813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE calling ADD team_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE calling ADD CONSTRAINT FK_A606C573296CD8AE FOREIGN KEY (team_id) REFERENCES med_team (id)');
