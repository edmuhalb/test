...
namespace App\Controller\PartnerApi\Report\Hospital;

use App\Security\PartnerUserIdentity;
use App\Query\Report\Partner\Hospital\AmountOfRewardForTheYear\Fetcher;
use App\Query\Report\Partner\Hospital\AmountOfRewardForTheYear\Query;
use DateTime;
...
#[Route('/partner/report/hospital/amount-of-reward-for-the-year', name: 'partner_report_hospital_amount_of_reward', methods: ['GET'])]
