...
#[Route('/api/my/kpi-hospital-for-year', name: 'api_my_kpi_hospital_for_year', methods: ['GET'])]
class KpiHospitalForYearAction extends AbstractController
{
