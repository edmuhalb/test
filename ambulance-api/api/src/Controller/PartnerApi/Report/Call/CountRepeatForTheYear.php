...
use App\Query\Report\Partner\Call\CountRepeatForTheYear\Fetcher;
use App\Query\Report\Partner\Call\CountRepeatForTheYear\Query;
use DateTime;
...
#[Route('/partner/report/call/count-repeat-for-the-year', name: 'partner_report_call_count_repeat_for_the_year', methods: ['GET'])]
class CountRepeatForTheYear extends AbstractController
{
